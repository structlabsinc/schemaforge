...
ALTER TABLE policies ADD COLUMN provider_id INT;

ALTER TABLE policies MODIFY COLUMN coverage_limit DECIMAL(12, 2);

ALTER TABLE policies ADD CONSTRAINT fk_policies_provider FOREIGN KEY (provider_id) REFERENCES providers(provider_id);